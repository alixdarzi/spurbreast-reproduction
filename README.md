...
The primary close reproduction is complete. The selected lock is SGD at
learning rate 0.01 with a cosine schedule and ImageNet normalization
(`H4_norm`). Seeds 2025-2027 each completed 50 epochs and were evaluated once
after validation-only checkpoint selection. Mean test accuracy is
**0.5175 ± 0.0060**, compared with 0.52 in Table 2. The mean test
predicted-positive rate is 0.8735 at 1.5 T and 0.0200 at 3 T, confirming strong
shortcut reliance. See [`reports/FINAL_REPORT.md`](reports/FINAL_REPORT.md),
[`reports/final_results/`](reports/final_results/), and
[`docs/STATUS.md`](docs/STATUS.md).

## Final Table 2 comparison

| Split | Metric | Paper | Reproduction mean ± SD |
|---|---|---:|---:|
| Training | Accuracy / PPV / NPV | 0.99 / 0.98 / 0.99 | 0.9998 / 0.9995 / 1.0000 |
| Validation | Accuracy / PPV / NPV | 0.99 / 1.00 / 0.98 | 0.9893 / 0.9957 / 0.9831 |
| Test | Accuracy / PPV / NPV | 0.52 / 0.62 / 0.41 | 0.5175 / 0.5215 / 0.5148 |

The accuracy and shortcut-collapse criteria are met. The test PPV/NPV mismatch
is reported rather than concealed because the published balanced-test triplet
cannot be generated by one standard global confusion matrix.
