...
| Patient split | §3.1, Table 1 | Filename patient ID | Exact folder membership plus assertions | Verified: 400/150/150 disjoint patients |
| Shortcut direction | §4 | Not exposed | Join TCIA metadata | Verified in train/validation; test oracle discrepancy documented |
...
| Metrics | Table 2 | None | Global confusion matrix | Paper aggregation unresolved; released oracle recorded |
